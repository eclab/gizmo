...
\begin{itemize}
\item First, you can {\it merge} two incoming channels: the Default MIDI In channel and a {\bf Merge Channel}.  Additionally you can also merge {\it all} channels by simply setting the Default MIDI In channel to OMNI.
...
\end{wrapfigure}
	...
	You can also restart the stopwatch by sending Gizmo three MIDI (clock) Stop commands in succession even if Gizmo is not responding to external MIDI Clock commands.
...
\vbox{		\begin{description}
	...
	\item{\bf Control MIDI}\\
		...
		\noindent\begin{tabular}{@{}rr|lllp{2.4in}@{}}
		...
		102&2	&0 (released)	&1 (pressed) & MSB& Press/Release the Back Button\\
		103&3	&0 (released)	&1 (pressed) & MSB & Press/Release the Middle Button\\
		104&4	&0 (released)	&1 (pressed) & MSB & Press/Release the Select Button\\
		105&5	&0 (un-bypass)	&1 (bypass) & MSB& Toggle Bypass\\
