...
The Drum Sequencer also responds to the {\it Transpose} option (because all applications do) but this is a nuisance as it changes the drum notes.  I strongly suggest you set Transpose to 0.
...
119	&	Any		& Pause\\
120	&	Any		& Schedule Next Sequence&{\it Only available via CC}\\
...
22	&	0--127		& Set Gizmo's Transpose (Select to set, Back to cancel)&\it Not useful for Drum Sequencer\\
