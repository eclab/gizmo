...
\begin{itemize}
\item None (\texttt{----})
\item {\it Intervals:} minor 3, Major 3, 4th, 5th, minor sixth, Major sixth, octave, octave + minor 3, octave + Major 3 interval, octave + fifth, 2 octaves, octave {\it below}, 2 octaves {\it below}
\item {\it Triads:} minor, minor 1st inversion, minor 2nd inversion, Major, Major 1st inversion, Major 2nd inversion
\item {\it Sevenths:} dominant, Major, minor, diminished
\end{itemize}
...
\item {\bf Fader (Track)}\quad This lets you specify a volume modifier which is multiplied against the velocities of the notes in the track.  Possible values are 0 ... 15 as follows: 0 is fully hushed, 1 is 1/8 velocity, 2 is 1/4 velocity .... 4 is 1/8 velocity ... 8 is normal velocity ... 15 is almost twice velocity.  {\it The Fader is not available when using chords}, sorry.
