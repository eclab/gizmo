...
\begin{itemize}
\item {\bf Play Along}  This menu option lets you choose to {\it play along} with the sequence (as you play notes they will be sent to MIDI Out)  or to {\it transpose} the sequence in real-time by pressing a key.   The menu options are 1...16 (the MIDI channel to route your played notes) or ``Transpose''.
...
{\small
\begin{tabular}{@{}llll@{}}
Control					& Edit Cursor Mode	& Play Cursor Mode	& Performance Mode\\
\hline
Back Button				& Exit  & Exit & Leave Performance Mode\\
Back Button (Long)			& Bypass & Bypass & Bypass\\
Middle Button				& Rest & Mute/Unmute Track & Mute/Unmute Track\\
...
Select + Middle Button (Long) 	& Enter Performance Mode & Enter Performance Mode & Next Sequence\\
