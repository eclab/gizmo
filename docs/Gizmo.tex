...
\item Mute and Solo no longer serve any purpose and are not available.
...
A {\bf Duophonic} format works very similarly, except that two tracks play at the same time in Performance Mode.  It differs from the Monophonic formats in the following ways;
