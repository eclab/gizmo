...
When you choose the Note Recorder from the root menu, you will be asked to either load a recording from a slot.  You can do this, or you can create a new empty recording by choosing ``-~-~-~-'' (meaning {\it none}).  After this you will enter the Note Recorder.

\begin{wrapfigure}{r}{1.5in}
\includegraphics[width=1.5in]{recorderstatus.pdf}
\vspace{-2em}\caption{\small Recorder Status LEDs}\vspace{-2em}
...
You can save your recorded song by pressing the Select Button.  Gizmo will ask you to select a slot to save in, then it will exit the Recorder.
...
The Recorder presently quantizes to each MIDI Clock pulse, that is, 1/24 of a quarter note.
